...
config_default_optimizer['lr'] = 5e-4  # 初始学习率
...
config_default_output_nets['output_module'] = 'hamse'  # 使用的输出模块名称
...
config_default_HamGNN_out['num_k'] = 3  # k点数量
config_default_HamGNN_out['soc_switch'] = False  # 是否开启自旋轨道耦合(SOC)
config_default_HamGNN_out['nonlinearity_type'] = 'norm'  # 非线性激活函数类型
config_default_HamGNN_out['band_num_control'] = {'C':6,'O':6}  # 能带数量控制
config_default_HamGNN_out['k_path'] = [[0.5, 0.0, 0.0],[0.5, 0.5, 0.5],[0.5, 0.5, 0.0],[0.0, 0.0, 0.0],[0.5, 0.5, 0.5]]  # k点路径
...
# 后处理 (post_processing)
# ------------------------------------------------------------------------------
config_default_post_processing = dict()
config_default_post_processing['post_utility'] = 'EPC'
config_default_EPC = dict()
config_default_post_processing['EPC'] = config_default_EPC
config_default['post_processing'] = config_default_post_processing

# ------------------------------------------------------------------------------
# 分子动力学 (molecular_dynamics)
# ------------------------------------------------------------------------------
config_default_molecular_dynamics = dict()
config_default_molecular_dynamics['logdir'] = './'
config_default_molecular_dynamics['device'] = None
config_default_molecular_dynamics['model'] = None
config_default_molecular_dynamics['initial_xyz'] = ''
config_default_molecular_dynamics['seed'] = 66
config_default_molecular_dynamics['r_max'] = 6.0
config_default_molecular_dynamics['log_frequency'] = 2
config_default_molecular_dynamics['save_frequency'] = 2
config_default_molecular_dynamics['temperature'] = 300.0
config_default_molecular_dynamics['dt'] = 0.1
config_default_molecular_dynamics['n_steps'] = 100
config_default_molecular_dynamics['nvt_q'] = 43.06225052549201
config_default_molecular_dynamics['energy_units_to_eV'] = 1.0
config_default_molecular_dynamics['length_units_to_A'] = 1.0
config_default['molecular_dynamics'] = config_default_molecular_dynamics
